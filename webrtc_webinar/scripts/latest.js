    ...
    return function(e, t, n) {
        ...
        5: [function(e, t) {
            ...
            var i = window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
                r = window.mozRTCIceCandidate || window.RTCIceCandidate,
                a = window.mozRTCSessionDescription || window.RTCSessionDescription,
                s = window.webkitMediaStream || window.MediaStream,
                c = "https:" === window.location.protocol && ("webkit" === n && o >= 26 || "moz" === n && o >= 33),
                u = window.AudioContext || window.webkitAudioContext,
                p = document.createElement("video"),
                l = p && p.canPlayType && "probably" === p.canPlayType('video/webm; codecs="vp8", vorbis'),
                d = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.msGetUserMedia || navigator.mozGetUserMedia;
            t.exports = {
                prefix: n,
                browserVersion: o,
                support: !!i && l && !!d,
        ...
        8: [function(e, t, n) {
            ...
            e("events"), n.isArray = o, n.isDate = function(e) {
                ...
                function p(e, c) {
                    ...
                    var g, y, v;
                    if (o(e) ? (y = "Array", v = ["[", "]"]) : (y = "Object", v = ["{", "}"]), "function" == typeof e) {
                        var b = e.name ? ": " + e.name : "";
                        g = i(e) ? " " + e : " [Function" + b + "]"
                    } else g = "";
                    if (r(e) && (g = " " + e.toUTCString()), 0 === h.length) return v[0] + g + v[1];
                    if (0 > c) return i(e) ? d("" + e, "regexp") : d("[Object]", "special");
                    l.push(e);
                    var S = h.map(function(t) {
                        var n, i;
                    ...
                    l.pop();
                    var w = 0,
                        k = S.reduce(function(e, t) {
                            return w++, t.indexOf("\n") >= 0 && w++, e + t.length + 1
                        }, 0);
                    return S = k > 50 ? v[0] + ("" === g ? "" : g + "\n ") + " " + S.join(",\n  ") + " " + v[1] : v[0] + g + " " + S.join(", ") + " " + v[1]
                }
                var l = [],
                    d = function(e, t) {
                        var n = {
                ...
                if (function(e, t) {
                    ...
                    function e() {
                        if (!V) {
                            ...
                            V = !0;
                            for (var n = F.length, o = 0; n > o; o++) F[o]()
                        }
                    }
                    ...
                    function n(e) {
                        if (typeof R.addEventListener != x) R.addEventListener("load", e, !1);
                        else if (typeof L.addEventListener != x) L.addEventListener("load", e, !1);
                        else if (typeof R.attachEvent != x) y(R, "onload", e);
                        ...
                        if (e > 0)
                            for (var t = 0; e > t; t++) {
                                ...
                                if (H.pv[0] > 0) {
                                    var r = m(n);
                                    if (r)
                                        if (!v(B[t].swfVersion) || H.wk && H.wk < 312)
                                    ...
                                    else S(n, !0), o && (i.success = !0, i.ref = a(n), o(i))
                                } else if (S(n, !0), o) {
                                    var g = a(n);
                    ...
                    function s() {
                        return !U && v("6.0.65") && (H.win || H.mac) && !(H.wk && H.wk < 312)
                    }
                    ...
                    function c(e, t, n, o) {
                        ...
                        var i = m(n);
                        if (i) {
                            "OBJECT" == i.nodeName ? (k = p(i), C = null) : (k = i, C = n), e.id = M, (typeof e.width == x || !/%$/.test(e.width) && parseInt(e.width, 10) < 310) && (e.width = "310"), (typeof e.height == x || !/%$/.test(e.height) && parseInt(e.height, 10) < 137) && (e.height = "137"), L.title = L.title.slice(0, 47) + " - Flash Player Installation";
                            var r = H.ie && H.win ? ["Active"].concat("").join("X") : "PlugIn",
                                a = "MMredirectURL=" + R.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + r + "&MMdoctitle=" + L.title;
                            if (typeof t.flashvars != x ? t.flashvars += "&" + a : t.flashvars = a, H.ie && H.win && 4 != i.readyState) {
                                var s = g("div");
                    ...
                    function p(e) {
                        var t = g("div");
                        if (H.win && H.ie) t.innerHTML = e.innerHTML;
                        else {
                    ...
                    function l(e, t, n) {
                        var o, i = m(n);
                        if (H.wk && H.wk < 312) return o;
                        if (i)
                            if (typeof e.id == x && (e.id = n), H.ie && H.win) {
                                var r = "";
                                ...
                                i.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + r + ">" + s + "</object>", $[$.length] = e.id, o = m(e.id)
                            } else {
                                var u = g(j);
                    ...
                    function f(e) {
                        var t = m(e);
                        t && "OBJECT" == t.nodeName && (H.ie && H.win ? (t.style.display = "none", function() {
                    ...
                    function b(e, t, n, o) {
                        if (!H.ie || !H.mac) {
                            ...
                            if (i) {
                                ...
                                if (o && (O = null, T = null), !O || T != r) {
                                    var a = g("style");
                                    a.setAttribute("type", "text/css"), a.setAttribute("media", r), O = i.appendChild(a), H.ie && H.win && typeof L.styleSheets != x && L.styleSheets.length > 0 && (O = L.styleSheets[L.styleSheets.length - 1]), T = r
                                }
                                H.ie && H.win ? O && typeof O.addRule == j && O.addRule(e, t) : O && typeof L.createTextNode != x && O.appendChild(L.createTextNode(e + " {" + t + "}"))
                            }
                        }
                    }
                    ...
                    function S(e, t) {
                        if (q) {
                            ...
                            V && m(e) ? m(e).style.visibility = n : b("#" + e, "visibility:" + n)
                        }
                    }
                    ...
                    var k, C, _, E, O, T, x = "undefined",
                        ...
                        q = !0,
                        H = function() {
                            var e = typeof L.getElementById != x && typeof L.getElementsByTagName != x && typeof L.createElement != x,
                                ...
                                s = [0, 0, 0],
                                c = null;
                            if (typeof P.plugins != x && typeof P.plugins[A] == j) c = P.plugins[A].description, !c || typeof P.mimeTypes != x && P.mimeTypes[I] && !P.mimeTypes[I].enabledPlugin || (W = !0, a = !1, c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), s[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), s[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), s[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
                            else if (typeof R[["Active"].concat("Object").join("X")] != x) try {
                    ...
                    return function() {
                            H.w3 && ((typeof L.readyState != x && "complete" == L.readyState || typeof L.readyState == x && (L.getElementsByTagName("body")[0] || L.body)) && e(), V || (typeof L.addEventListener != x && L.addEventListener("DOMContentLoaded", e, !1), H.ie && H.win && (L.attachEvent(N, function() {
                                "complete" == L.readyState && (L.detachEvent(N, arguments.callee), e())
                            }), R == top && function() {
                                if (!V) {
                                    try {
                                ...
                                return V ? void 0 : /loaded|complete/.test(L.readyState) ? (e(), void 0) : (setTimeout(arguments.callee, 0), void 0)
                            }(), n(e)))
                        }(),
                        function() {
                            ...
                            registerObject: function(e, t, n, o) {
                                if (H.w3 && e && t) {
                                    var i = {};
                                    i.id = e, i.swfVersion = t, i.expressInstall = n, i.callbackFn = o, B[B.length] = i, S(e, !1)
                                } else o && o({
                                    success: !1,
                                    id: e
                                })
                            ...
                            embedSWF: function(e, n, o, i, r, a, u, p, d, f) {
                                ...
                                H.w3 && !(H.wk && H.wk < 312) && e && n && o && i && r ? (S(n, !1), t(function() {
                                    o += "", i += "";
                                    var t = {};
                                    if (d && typeof d === j)
                                    ...
                                    if (v(r)) {
                                        var w = l(t, g, n);
                                        t.id == n && S(n, !0), h.success = !0, h.ref = w
                                    } else {
                            ...
                            expressInstallCallback: function() {
                                if (U) {
                                    var e = m(M);
                                    e && k && (e.parentNode.replaceChild(k, e), C && (S(C, !0), H.ie && H.win && (k.style.display = "block")), _ && _(E)), U = !1
                                }
                            }
                        }
                }();
        ...
        16: [function(e, t) {
            ...
            t.exports = function(e, t) {
                var o, i = 2 === arguments.length,
                    ...
                    s = "PERMISSION_DENIED",
                    c = "ConstraintNotSatisfiedError";
                return i || (t = e, e = r), n ? e.audio || e.video ? (localStorage && "true" === localStorage.useFirefoxFakeDevice && (e.fake = !0), n.call(window.navigator, e, function(e) {
                    t(null, e)
                }, function(e) {
                    var n;
                    "string" == typeof e ? (n = new Error("MediaStreamError"), n.name = e === a || e === s ? a : c) : (n = e, n.name || (e.name = n[a] ? a : c)), t(n)
                }), void 0) : (o = new Error("MediaStreamError"), o.name = "NoMediaRequestedError", window.setTimeout(function() {
                    t(o)
                }, 0)) : (o = new Error("MediaStreamError"), o.name = "NotSupportedError", window.setTimeout(function() {
                    t(o)
                }, 0))
            }
        }, {}],
        ...
        14: [function(e, t) {
            function n(e, t) {
                var n, o = this;
                c.call(this), e = e || {}, e.iceServers = e.iceServers || [], this.enableChromeNativeSimulcast = !1, t && t.optional && "webkit" === a.prefix && null === navigator.appVersion.match(/Chromium\//) && t.optional.forEach(function(e) {
                    e.enableChromeNativeSimulcast && (o.enableChromeNativeSimulcast = !0)
                }), this.enableMultiStreamHacks = !1, t && t.optional && "webkit" === a.prefix && t.optional.forEach(function(e) {
                ...
                }), this.batchedIceCandidates = [], t && t.optional && "webkit" === a.prefix && t.optional.forEach(function(e) {
                ...
                }), "moz" === a.prefix && t && t.optional && (this.wtFirefox = 0, t.optional.forEach(function(e) {
                    e.andyetFirefoxMakesMeSad && (o.wtFirefox = e.andyetFirefoxMakesMeSad, o.wtFirefox > 0 && (o.firefoxcandidatebuffer = []))
                })), this.pc = new u(e, t), this.getLocalStreams = this.pc.getLocalStreams.bind(this.pc), this.getRemoteStreams = this.pc.getRemoteStreams.bind(this.pc), this.addStream = this.pc.addStream.bind(this.pc), this.removeStream = this.pc.removeStream.bind(this.pc), this.pc.on("*", function() {
            ...
            var o = e("util"),
                ...
                s = e("sdp-jingle-json"),
                c = e("wildemitter"),
                u = e("traceablepeerconnection");
            o.inherits(n, c), Object.defineProperty(n.prototype, "signalingState", {
                get: function() {
                ...
                if (e.contents || e.jingle && e.jingle.contents) {
                    var o = r(this.remoteDescription.contents, "name"),
                    ...
                    i.forEach(function(e) {
                        ...
                        i.forEach(function(e) {
                            ...
                            n.pc.addIceCandidate(new a.IceCandidate({
                                candidate: t,
                                sdpMLineIndex: r,
                                sdpMid: c
                            }), function() {}, function(e) {
                    ...
                    n.pc.addIceCandidate(new a.IceCandidate(e.candidate), function() {}, function(e) {
                        n.emit("error", e)
                ...
                return t = o ? t : e, t = t || function() {}, "closed" === this.pc.signalingState ? t("Already closed") : (this.pc.createOffer(function(e) {
                    var o = {
                        type: "offer",
                        sdp: e.sdp
                    };
                ...
                }), n.pc.setRemoteDescription(new a.SessionDescription(e), function() {
                    t()
                }, t)
                ...
                e.jingle && (e.sdp = s.toSessionSDP(e.jingle, {
                    ...
                    n.wtFirefox && window.setTimeout(function() {
                        n.firefoxcandidatebuffer.forEach(function(e) {
                            n.pc.addIceCandidate(new a.IceCandidate(e), function() {}, function(e) {
                                n.emit("error", e)
                ...
                return "closed" === this.pc.signalingState ? t("Already closed") : (n.pc.createAnswer(function(e) {
                    ...
                    if (n.enableChromeNativeSimulcast && (e.jingle = s.toSessionJSON(e.sdp, {
                        ...
                        if (i.forEach(function(e) {
                            ...
                            a.ssrc = "" + Math.floor(4294967295 * Math.random()), e.jingle.contents[1].description.sources.push(a), o.push(e.jingle.contents[1].description.sources[0].ssrc), o.push(a.ssrc), i.push({
                                semantics: "SIM",
                                sources: o
                            });
                            ...
                            }), e.jingle.contents[1].description.sourceGroups = i, e.sdp = s.toSessionSDP(e.jingle, {
                                sid: n.config.sdpSessionID,
                                role: n._role(),
                                direction: "outgoing"
                            })
                    ...
                    n.assumeSetLocalSuccess && (n.emit("answer", u), t(null, u)), n._candidateBuffer = [], n.pc.setLocalDescription(e, function() {
                        if (n.config.useJingle) {
                            var o = s.toSessionJSON(e.sdp, {
                                role: n._role(),
                                direction: "outgoing"
                            });
                            o.sid = n.config.sid, n.localDescription = o, u.jingle = o
                        }
                        n.enableChromeNativeSimulcast && (u.jingle || (u.jingle = s.toSessionJSON(e.sdp, {
                            role: n._role(),
                            direction: "outgoing"
                ...
                if (e.candidate) {
                    ...
                    var r, a, c = s.toCandidateJSON(n.candidate);
                    if (this.eliminateDuplicateCandidates && "relay" === c.type && (r = this._candidateBuffer.filter(function(e) {
                        ...
                        }), a = r.indexOf(c.foundation + ":" + c.component), a > -1 && c.priority >> 24 >= r[a].priority >> 24)) return;
                    if ("max-bundle" === this.config.bundlePolicy && (r = this._candidateBuffer.filter(function(e) {
                        ...
                        }), a = r.indexOf(c.address + ":" + c.port), a > -1)) return;
                    ...
                    if (this._candidateBuffer.push(c), t.config.useJingle) {
                        if (n.sdpMid || (n.sdpMid = t.pc.remoteDescription && "offer" === t.pc.remoteDescription.type ? t.remoteDescription.contents[n.sdpMLineIndex].name : t.localDescription.contents[n.sdpMLineIndex].name), !t.config.ice[n.sdpMid]) {
                            var u = s.toSessionJSON(t.pc.localDescription.sdp, {
                                role: t._role(),
                                direction: "outgoing"
                            });
                ...
                "moz" === a.prefix ? this.pc.getStats(function(t) {
                    var n = [];
                ...
                var y = function() {
                    setTimeout(function() {
                        if (d) {
                            ...
                            a.speakingHistory.shift(), a.speakingHistory.push(0 + (e > u)), y()
                        }
                    }, c)
                };
                return y(), a
                ...
                if (window.navigator.userAgent.match("Chrome")) {
                    ...
                    if (window.navigator.userAgent.match("Linux") && (c = 35), sessionStorage.getScreenMediaJSExtensionId) chrome.runtime.sendMessage(sessionStorage.getScreenMediaJSExtensionId, {
                        ...
                        if ("" === e.sourceId) {
                            ...
                            o.video.mandatory.chromeMediaSourceId = e.sourceId, n(o, a)
                        }
                    });
        ...
        22: [function(e, t) {
            ...
            var o = e("lodash._arrayeach"),
                i = e("lodash._baseeach"),
                r = e("lodash._bindcallback"),
                a = e("lodash.isarray"),
                s = n(o, i);
            t.exports = s
        }, {
        ...
        31: [function(e, t) {
            ...
            function r(e) {
                return "number" == typeof e && e > -1 && 0 == e % 1 && b >= e
            }

            function a(e) {
                return null == e ? !1 : g.call(e) == u ? y.test(h.call(e)) : o(e) && d.test(e)
            }

            function s(e) {
                return e = n(e), e && l.test(e) ? e.replace(p, "\\$&") : e
            }
            var c = "[object Array]",
                u = "[object Function]",
                p = /[.*+?^${}()|[\]\/\\]/g,
                ...
                m = f.hasOwnProperty,
                g = f.toString,
                y = RegExp("^" + s(h.call(m)).replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                v = i(Array, "isArray"),
                b = 9007199254740991,
                S = v || function(e) {
        ...
        26: [function(e, t, n) {
            ...
            n._setIdCounter = function(e) {
                ...
                if (m && (d.name = m.substr(6)), i.findLine("a=sendrecv", u, p) ? d.senders = "both" : i.findLine("a=sendonly", u, p) ? d.senders = o[s][c].sendonly : i.findLine("a=recvonly", u, p) ? d.senders = o[s][c].recvonly : i.findLine("a=inactive", u, p) && (d.senders = "none"), "rtp" == f.descType) {
                    ...
                    var y = i.findLine("a=ssrc:", u);
                    y && (f.ssrc = y.substr(7).split(" ")[0]);
                    var v = i.findLines("a=rtpmap:", u);
                    ...
                    var S = i.findLines("a=rtcp-fb:*", u);
                    S.forEach(function(e) {
                        f.feedback.push(i.rtcpfb(e))
                    });
                    var w = i.findLines("a=extmap:", u);
                ...
                var O = i.findLine("a=ice-ufrag:", u, p),
                    T = i.findLine("a=ice-pwd:", u, p);
                if (O && T) {
                    h.ufrag = O.substr(12), h.pwd = T.substr(10), h.candidates = [];
        ...
        32: [function(e, t) {
            ...
            function r(e) {
                return "number" == typeof e && e > -1 && 0 == e % 1 && l >= e
            }
        ...
        41: [function(e, t) {
            ...
            function r(e) {
                return null == e ? !1 : h.call(e) == s ? m.test(d.call(e)) : o(e) && p.test(e)
            }

            function a(e) {
                return e = n(e), e && u.test(e) ? e.replace(c, "\\$&") : e
            }
            var s = "[object Function]",
                ...
                f = l.hasOwnProperty,
                h = l.toString,
                m = RegExp("^" + a(d.call(f)).replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
            t.exports = i
        }, {}],
        42: [function(e, t) {
            function n(e) {
        ...
        37: [function(e, t) {
            ...
            function i(e, t) {
                return e = "number" == typeof e || d.test(e) ? +e : -1, t = null == t ? g : t, e > -1 && 0 == e % 1 && t > e
            }
            ...
            function a(e) {
                for (var t = c(e), n = t.length, o = n && e.length, a = !!o && r(o) && (l(e) || p(e)), s = -1, u = []; ++s < n;) {
                    var d = t[s];
                    (a && i(d, o) || h.call(e, d)) && u.push(d)
                }
                return u
            }
            ...
            function c(e) {
                ...
                for (var d in e) u && i(d, t) || "constructor" == d && (a || !h.call(e, d)) || c.push(d);
                return c
            }
        ...
        38: [function(e, t) {
            ...
            function o(e, t, n) {
                var o = typeof e;
                return "function" == o ? void 0 === t ? e : w(e, t, n) : null == e ? v : "object" == o ? a(e) : void 0 === t ? b(e) : s(e, t)
            }
            ...
            function r(e, t, n) {
                ...
                for (; ++o < i;) {
                    ...
                    if (r && a[2]) {
                        ...
                        if (!(void 0 === p ? S(u, c, n, !0) : p)) return !1
                    }
                }
                return !0
            }
            ...
            function s(e, t) {
                ...
                return e = m(e),
                    function(a) {
                        ...
                        return a[s] === t ? void 0 !== t || s in a : S(t, a[s], void 0, !0)
                    }
            }
            ...
            var S = e("lodash._baseisequal"),
                w = e("lodash._bindcallback"),
                k = e("lodash.isarray"),
                C = e("lodash.pairs"),
                _ = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/,
                E = /^\w*$/,
        ...
        47: [function(e, t) {
            ...
            function i(e) {
                return n(e) && o(e.length) && !!x[A.call(e)]
            }
            var r = "[object Arguments]",
                ...
                x = {};
            x[b] = x[S] = x[w] = x[k] = x[C] = x[_] = x[E] = x[O] = x[T] = !0, x[r] = x[a] = x[v] = x[s] = x[c] = x[u] = x[p] = x[l] = x[d] = x[f] = x[h] = x[m] = x[g] = x[y] = !1;
        ...
        45: [function(e, t) {
            ...
            function r(e, t, n, o, i, r, u) {
                var d = p(e),
                    ...
                    g = h,
                    y = h;
                d || (g = _.call(e), g == f ? g = b : g != b && (d = l(e))), m || (y = _.call(t), y == f ? y = b : y != b && (m = l(t)));
                var v = g == b,
                    S = y == b,
                    w = g == y;
                if (w && !d && !v) return s(e, t, g);
                if (!i) {
                    var k = v && C.call(e, "__wrapped__"),
                        E = S && C.call(t, "__wrapped__");
                    if (k || E) return n(k ? e.value() : e, E ? t.value() : t, o, i, r, u)
                }
                if (!w) return !1;
                r || (r = []), u || (u = []);
                for (var O = r.length; O--;)
                    if (r[O] == e) return u[O] == t;
                r.push(e), u.push(t);
                var T = (d ? a : c)(e, t, n, o, i, r, u);
                return r.pop(), u.pop(), T
            }
            ...
            function a(e, t, n, i, r, a, s) {
                var c = -1,
                    u = e.length,
                    p = t.length;
                if (u != p && !(r && p > u)) return !1;
                for (; ++c < u;) {
                    var l = e[c],
                        d = t[c],
                        f = i ? i(r ? d : l, r ? l : d, c) : void 0;
                    if (void 0 !== f) {
                        if (f) continue;
                        return !1
                    }
                    if (r) {
                        if (!o(t, function(e) {
                                return l === e || n(l, e, i, r, a, s)
                            })) return !1
                    } else if (l !== d && !n(l, d, i, r, a, s)) return !1
                }
                return !0
            }
            ...
            function c(e, t, n, o, i, r, a) {
                ...
                for (var h = i; ++l < c;) {
                    ...
                    var m = e[f],
                        g = t[f],
                        y = o ? o(i ? g : m, i ? m : g, f) : void 0;
                    if (!(void 0 === y ? n(m, g, o, i, r, a) : y)) return !1;
                    h || (h = "constructor" == f)
                }
                if (!h) {
                    var v = e.constructor,
                        b = t.constructor;
                    if (v != b && "constructor" in e && "constructor" in t && !("function" == typeof v && v instanceof v && "function" == typeof b && b instanceof b)) return !1
                }
                return !0
            }
        ...
        43: [function(e, t) {
            ...
            "lodash._getnative": 49,
            "lodash.isarguments": 48,
            "lodash.isarray": 31
        }]
    }, {}, [1])(1)
});